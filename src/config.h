...
/* Build date */
#define BUILD_DATE "Mon Mar 25 17:31:22 CDT 2024"

/* Build host */
#define BUILD_HOST "barnstorm"
...
#define FLARQ_BUILD_CXXFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/fileselector -I$(srcdir)/flarq-src -I$(srcdir)/flarq-src/include -I$(srcdir)/xmlrpcpp -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -pipe -Wall -fexceptions -O2 -I$(srcdir)/xmlrpcpp -DNDEBUG"

/* Flarq linker flags */
#define FLARQ_BUILD_LDFLAGS "-lfltk_images -lfltk -lX11 -lX11"

/* Flarq Docs index */
#define FLARQ_DOCS "http://www.w1hkj.com/FlarqHelpFiles/flarq.html"

/* Flarq version string */
#define FLARQ_VERSION "4.3.9"
...
#define FLARQ_VERSION_PATCH ".9"

/* Fldigi authors */
#define FLDIGI_AUTHORS "Dave Freese, Stelios Bounanos, and others"

/* Fldigi cc compiler flags */
#define FLDIGI_BUILD_CFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/irrxml -I$(srcdir)/libtiniconv -I$(srcdir)/fileselector -I$(srcdir)/xmlrpcpp -I$(srcdir)/mbedtls -pthread -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/opus -I/usr/include/libusb-1.0 -I/usr/include/libpng16 -pipe -Wall -fexceptions -O2 --param=max-vartrack-size=0 -I$(srcdir)/xmlrpcpp --param=max-vartrack-size=0 -DNDEBUG"

/* Fldigi cpp compiler flags */
#define FLDIGI_BUILD_CXXFLAGS "-I$(srcdir) -I$(srcdir)/include -I$(srcdir)/irrxml -I$(srcdir)/libtiniconv -I$(srcdir)/fileselector -I$(srcdir)/xmlrpcpp -I$(srcdir)/mbedtls -pthread -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/cairo -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/uuid -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/opus -I/usr/include/libusb-1.0 -I/usr/include/libpng16 -pipe -Wall -fexceptions -O2 --param=max-vartrack-size=0 -I$(srcdir)/xmlrpcpp --param=max-vartrack-size=0 -DNDEBUG"

/* Fldigi linker flags */
#define FLDIGI_BUILD_LDFLAGS "-lportaudio -lasound -lm -lpthread -lfltk_images -lfltk -lX11 -lX11 -lsndfile -lsamplerate -lhamlib -lpng16 -lz -ludev"
...
/* hamlib version */
#define HAMLIB_BUILD_VERSION "4.3.1"
...
/* libmbedtls version */
#define LIBMBEDTLS_BUILD_VERSION ""
...
#define PACKAGE_STRING "fldigi 4.2.04"
...
#define PACKAGE_VERSION "4.2.04"

/* png version */
#define PNG_BUILD_VERSION "1.6.37"

/* portaudio version */
#define PORTAUDIO_BUILD_VERSION "19"

/* pulseaudio version */
#define PULSEAUDIO_BUILD_VERSION ""

/* samplerate version */
#define SAMPLERATE_BUILD_VERSION "0.2.2"
...
/* sndfile version */
#define SNDFILE_BUILD_VERSION "1.0.31"
...
/* Define to 1 if we are using libmbedtls */
#define USE_LIBMBEDTLS 0
