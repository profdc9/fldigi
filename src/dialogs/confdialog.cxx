...
static void cb_btn_check_btn_color(Fl_Button*, void*) {
  progdefaults.default_check_btn_color = fl_show_colormap(progdefaults.default_check_btn_color);
default_check_btn_color->color(progdefaults.default_check_btn_color);
...
static void cb_btn_default_round_btn_color(Fl_Button*, void*) {
  progdefaults.default_round_btn_color = fl_show_colormap(progdefaults.default_round_btn_color);
default_round_btn_color->color(progdefaults.default_round_btn_color);
...
static void cb_btnMonitorColor(Fl_Button* o, void*) {
  if (fl_color_chooser("Notch Indicator",
  progdefaults.monitorRGBI.R,
  progdefaults.monitorRGBI.G,
  progdefaults.monitorRGBI.B) ) {
...
Fl_Double_Window* ConfigureDialog() {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(800, 380, _("Fldigi configuration"));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, _("Call/Lookup"));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, _("Call/cty.dat"));
      o->box(FL_ENGRAVED_BOX);
      o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
      o->hide();
      { Fl_Input2* o = txt_cty_dat_pathname = new Fl_Input2(330, 56, 346, 24, _("cty.dat folder"));
      ...
      { btn_select_cty_dat = new Fl_Button(235, 101, 75, 24, _("Browse"));
      ...
      { btn_default_cty_dat = new Fl_Button(330, 101, 75, 24, _("Default"));
      ...
      { btn_reload_cty_dat = new Fl_Button(425, 101, 75, 24, _("Reload"));
...
work!"));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, _("Logging/QSO logging"));
      ...
      { Fl_Input2* o = inpMyPower = new Fl_Input2(368, 219, 50, 24, _("Transmit Power"));
      ...
      { Fl_Check_Button* o = btn_log_power_meter = new Fl_Check_Button(444, 221, 155, 20, _("Log power meter "));
